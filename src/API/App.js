...
export default class App {
  ...
  constructor ({ name, version, contributors, root }) {
    ...
    this.#version = this.#validateVersion(version ?? '0.0.1-alpha.1')
    this.#contributors = (Array.isArray(contributors) ? contributors : [contributors]).map(contributor => new Contributor(contributor))
